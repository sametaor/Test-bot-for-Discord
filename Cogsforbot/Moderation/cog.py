...
class Moderation(commands.Cog):
    ...
    async def giverole(self, ctx, emoji, role : nextcord.Role, *, rolemessage):
        emb = nextcord.Embed(title='Reaction role!', description=rolemessage, colour = role.colour)
        ...
        embvone = nextcord.Embed(title='Reactions role!', description=rolemessage, colour = nextcord.Colour.magenta())
